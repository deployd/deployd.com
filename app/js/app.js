...
"><img src="/img/apple.gif">',
            ...
            '</div>',
            '<div class="span1 platform">',
              '<a target="_blank" href="https://docs.google.com/file/d/0Bw6GBXhPGkUGa0c1VldLOGNZNjg"><img src="/img/win.gif">',
              '<br>win</a>',
            '</div>',
            '<div class="span1 platform">',
              '<a target="_blank" href="https://github.com/deployd/deployd/zipball/v0.6.10"><img src="/img/source.png">',
              '<br>source</a>',
            '</div>',
